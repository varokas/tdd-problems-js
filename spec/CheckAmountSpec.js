...
describe("When CheckAmount is instantiated with ", function () {
    ...
    describe("million numbers", function () {
        [
            ...
            { word: "two hundred million dollars", number: 200000000 },
        ].forEach(function (e) {
            it("should return \"" + e.word + "\" when given value is " + e.number, function () {
                expect(new CheckAmount(e.number).toString()).toEqual(e.word);
            });
    ...
    describe("trillion numbers", function () {
        [
            { word: "one trillion dollars", number: 1000000000000 }
        ].forEach(function (e) {
            it("should return \"" + e.word + "\" when given value is " + e.number, function () {
                expect(new CheckAmount(e.number).toString()).toEqual(e.word);
            });
    ...
    describe("mixed numbers", function() {
        [
            ...
            { word: "two thousand five hundred twenty-three dollars", number: 2523 },
            { word: "three and 04/100 dollars", number: 3.04 },
            { word: "two thousand five hundred twenty-three and 04/100 dollars", number: 2523.04 },
            { word: "two thousand five hundred twenty-three and 99/100 dollars", number: 2523.99 },
        ].forEach(function (e) {
            it("should return \"" + e.word + "\" when given value is " + e.number, function () {
                expect(new CheckAmount(e.number).toString()).toEqual(e.word);
            });
