describe("PokerGame", function () {
	...
	describe("should score according to their rank.", function () {
		...
		{rank : '5',  suite : 'C', score : 6  },
		{rank : '6',  suite : 'C', score : 7  },
		{rank : '7',  suite : 'C', score : 8  },
		{rank : '8',  suite : 'C', score : 9  },
		{rank : '9',  suite : 'C', score : 10 },
		{rank : '10', suite : 'C', score : 11 },
		{rank : 'J',  suite : 'C', score : 12 },
		{rank : 'Q',  suite : 'C', score : 13 },
		{rank : 'K',  suite : 'C', score : 14 },
		{rank : 'A',  suite : 'C', score : 15 },
	    ]
	    .forEach(function(e) {
